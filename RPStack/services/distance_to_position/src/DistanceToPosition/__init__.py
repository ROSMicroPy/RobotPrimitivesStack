...
try:
    from RPInterfaces import PositionObserver, PositionSample, PrimitiveService
except ImportError:
    from RPStack.services.interfaces import PositionObserver, PositionSample, PrimitiveService
