...
_DEFAULT_APP_URLS = (
    ...
    "https://raw.githubusercontent.com/ROSMicroPy/RobotPrimitivesStack/archdef/RPStack/control/shell/package.json",
    "https://gitlab.com/robot-primitives/micropython_modules/mp_uemacs/-/raw/main/py/package.json",
)


# Run boot initialization and print device-style exception diagnostics when available.
def run():
    try:
        _run()
...
# Add boot-manager startup calls to the main script and install default applications.
...
# Install each configured default application through MicroPython's package manager.
