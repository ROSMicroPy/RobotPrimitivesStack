...
mip.install(
    ...
    "archdef/RPStack/platform/env/package.json"
)
~~~
...
~~~bash
mpremote mip install RPStack/platform/env/package.json
~~~

From GitHub on the development branch:

~~~bash
mpremote mip install github:ROSMicroPy/RobotPrimitivesStack/RPStack/platform/env@archdef
~~~

A raw manifest URL is also supported:

~~~bash
mpremote mip install https://raw.githubusercontent.com/ROSMicroPy/RobotPrimitivesStack/archdef/RPStack/platform/env/package.json
~~~
