...
mip.install(
    ...
    "archdef/RPStack/observability/opentelemetry/package.json"
)
~~~
...
~~~bash
mpremote mip install RPStack/observability/opentelemetry/package.json
~~~

From GitHub on the development branch:

~~~bash
mpremote mip install github:ROSMicroPy/RobotPrimitivesStack/RPStack/observability/opentelemetry@archdef
~~~

A raw manifest URL is also supported:

~~~bash
mpremote mip install https://raw.githubusercontent.com/ROSMicroPy/RobotPrimitivesStack/archdef/RPStack/observability/opentelemetry/package.json
~~~
