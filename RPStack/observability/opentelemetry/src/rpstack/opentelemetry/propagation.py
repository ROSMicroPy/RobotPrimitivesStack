...
#
#
from .context import SpanContext, get_current_span_context


# Attach the current or supplied trace identity to outgoing HTTP headers.
...
# Split an incoming traceparent header into fields, returning None for missing or malformed
# framing.
...
# Attach trace identity to a configurable field in an outgoing message dictionary.
...
# Recover a remote span context from a valid trace identity in a message carrier.
