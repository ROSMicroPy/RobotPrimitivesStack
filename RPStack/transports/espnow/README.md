...
`rpstack.espnow:EspNowTransport` is RPStack's asynchronous ESP-NOW signal
...
[signal runtime](../../runtime/signals/README.md) for routing and delivery guarantees.
...
Use `rpstack.espnow.shared:SharedEspNowTransport` in each node's signal transport
...
[the REPL slide example](../../../examples/slide_nodes/README.md).
